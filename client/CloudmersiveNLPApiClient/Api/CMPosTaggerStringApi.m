#import "CMPosTaggerStringApi.h"
#import "CMQueryParamCollection.h"
#import "CMApiClient.h"


@interface CMPosTaggerStringApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation CMPosTaggerStringApi

NSString* kCMPosTaggerStringApiErrorDomain = @"CMPosTaggerStringApiErrorDomain";
NSInteger kCMPosTaggerStringApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) posTaggerStringPostWithInput: (NSString*) input
    ...
    if (input == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kCMPosTaggerStringApiErrorDomain code:kCMPosTaggerStringApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

...
-(NSURLSessionTask*) spellCheckCheckJsonWithValue: (NSString*) value
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"CMCheckJsonResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((CMCheckJsonResponse*)data, error);
                                }
                            }];
}
...
///  @param value Input sentence 
///
///  @returns CMCheckSentenceJsonResponse*
///
-(NSURLSessionTask*) spellCheckCheckSentenceJsonWithValue: (NSString*) value
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"CMCheckSentenceJsonResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((CMCheckSentenceJsonResponse*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) spellCheckCorrectJsonWithValue: (NSString*) value
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"CMCorrectJsonResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((CMCorrectJsonResponse*)data, error);
                                }
                            }];
}

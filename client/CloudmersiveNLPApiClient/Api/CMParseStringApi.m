#import "CMParseStringApi.h"
#import "CMQueryParamCollection.h"
#import "CMApiClient.h"


@interface CMParseStringApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation CMParseStringApi

NSString* kCMParseStringApiErrorDomain = @"CMParseStringApiErrorDomain";
NSInteger kCMParseStringApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) parseStringPostWithInput: (NSString*) input
    ...
    if (input == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kCMParseStringApiErrorDomain code:kCMParseStringApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

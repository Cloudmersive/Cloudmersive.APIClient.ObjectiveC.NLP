...
@interface CMWordsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation CMWordsApi

NSString* kCMWordsApiErrorDomain = @"CMWordsApiErrorDomain";
NSInteger kCMWordsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) wordsAdjectivesWithInput: (NSString*) input
    ...
    if (input == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kCMWordsApiErrorDomain code:kCMWordsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
...
///
///  @returns CMGetWordsJsonResponse*
///
-(NSURLSessionTask*) wordsGetWordsJsonWithInput: (NSString*) input
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"CMGetWordsJsonResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((CMGetWordsJsonResponse*)data, error);
                                }
                            }];
}

#import "CMSentencesApi.h"
#import "CMQueryParamCollection.h"
#import "CMApiClient.h"


@interface CMSentencesApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation CMSentencesApi

NSString* kCMSentencesApiErrorDomain = @"CMSentencesApiErrorDomain";
NSInteger kCMSentencesApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) sentencesPostWithInput: (NSString*) input
    ...
    if (input == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kCMSentencesApiErrorDomain code:kCMSentencesApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
